...
const BookingHistory = () => {
  ...
  const handleShowAllRecent = async () => {
    try {
  ...
  if (isLoading && !Array.isArray(bookingHistory)) {
    ...
    <div className="flex-1 p-4">
      ...
      <div className="text-center mb-6">
        ...
        <p className="text-gray-600">
          {searchPerformed ? 'ผลการค้นหาประวัติการจอง' : 'ประวัติการจอง 10 รายการล่าสุด'}
        </p>
      </div>

      {/* Toggle Search Form */}
      <div className="flex justify-center gap-2 mb-6">
        {!showSearchForm && !searchPerformed && (
          <Button
      ...
      <div className="space-y-4">
        {!Array.isArray(bookingHistory) || bookingHistory.length === 0 ? (
          <div className="bg-white rounded-lg shadow-sm p-8 text-center">
            ...
            <p className="text-gray-600">
              {searchPerformed 
                ? 'ไม่พบประวัติการจองสำหรับหมายเลขโทรศัพท์นี้' 
          ...
          <div className="space-y-4">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">
              {searchPerformed 
                ? `ประวัติการจองของ ${phoneNumber} (${bookingHistory.length} รายการ)`
                : `ประวัติการจองล่าสุด (${bookingHistory.length} รายการ)`
              }
            </h2>
